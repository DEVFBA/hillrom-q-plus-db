...
Example:
	...
	EXEC spQuotation_ApprovalRoutes_Get_Pending_Approval @pvUser = 'LUMU�OZ', @pvUserSaleExecutive = 'ADVEGA'
	EXEC spQuotation_ApprovalRoutes_Get_Pending_Approval @pvUser = 'LUMU�OZ', @piFolio = 2, @pvUserSaleExecutive = 'ADVEGA'
