...
/* ==================================================================================*/
-- spPDF_Layout_Get_Info_CH700B4
/* ==================================================================================*/	
PRINT 'Crea Procedure: spPDF_Layout_Get_Info_CH700B4'
IF OBJECT_ID('[dbo].[spPDF_Layout_Get_Info_CH700B4]','P') IS NOT NULL
       DROP PROCEDURE [dbo].spPDF_Layout_Get_Info_CH700B4
GO
/*
Autor:		Alejandro Zepeda
Desc:		Get spPDF_Layout_Get_Info_CH700B4
Date:		09/01/2022
Example:
...
*/
CREATE PROCEDURE [dbo].spPDF_Layout_Get_Info_CH700B4
AS
...
/*****************************************************************************/
-- QUERY 4 -  SUBCLASS = Lockable Drawer
/*****************************************************************************/
SELECT DISTINCT
	 Item_SubClass,
	 Id_Item,
...
/*****************************************************************************/
-- QUERY 5 -  SUBCLASS = Fixed strip or sliding tray
/*****************************************************************************/
SELECT DISTINCT
	 Item_SubClass,
	 Id_Item,
...
SELECT DISTINCT
 ...
 /*****************************************************************************/
-- QUERY 7 -  SUBCLASS = Acessory Bar Holder
/*****************************************************************************/
SELECT DISTINCT
	 Item_SubClass,
	 Id_Item,
...
/*****************************************************************************/
-- QUERY 8 -  SUBCLASS = Additional Options
/*****************************************************************************/
SELECT DISTINCT
	 Item_SubClass,
	 Id_Item,
 ...
 WHERE Id_ItemTemplate_Class IN ('PROD', 'ACCE')
	 AND Id_Line in ('CH700B4')
	 AND Id_Item_Class = 'COMP'
	 AND Id_Item_SubClass NOT IN ('ACCEBARHOL', 'CASTORS', 'FIXEDSLIDI', 'LOCKADRAWE','PLADRAWINS', 'HINGE', 'FIXSHECOLO', 'HANDLES','FIXSLICOLO', 'COLORS')
 ORDER BY Id_Item

/*****************************************************************************/
-- QUERY 9 -  SUBCLASS = COLORS
/*****************************************************************************/
SELECT DISTINCT
	Item_SubClass,
