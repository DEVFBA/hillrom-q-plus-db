        ...
        BEGIN
            ...
            WITH HierarchyWithIndex AS (
                ...
                SELECT 
                    ...
                    p.Parent_Level_3,
                    CASE 
                        WHEN ch.[Level] = 4 THEN CAST(NULL AS VARCHAR(10))  -- Level 4 has no Level 4 parent
            ...
            SELECT 
                ...
                --Id_Category,
                --Short_Desc AS Category_Name,
                Parent,
                [Level],
                [Order] AS Order_Within_Parent,
                HierarchyIndex,
                ...
                REPLICATE('    ', [Level] - 3) + HierarchyIndex + ' - ' + Short_Desc AS Tree_View
                --[Path],
                --[Status],
                --SortKey,
                --RootParent
            FROM HierarchyWithIndex
            WHERE 
                    [Status] = 1
                AND (@pvLineId = '' OR Parent_Level_2 = @pvLineId)
            ORDER BY 
