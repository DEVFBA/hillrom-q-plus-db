...
Date:		01/01/2021
Example:
			spCat_Languages_CRUD_Records @pvOptionCRUD = 'C', @pvIdLanguageUser = 'SPA', @pvIdLanguage = 'LMX' , @pvShortDesc = 'Español Latam', @pvLongDesc = 'Español Latinoamerica', @pbStatus = 1, @pvUser = 'AZEPEDA', @pvIP ='192.168.1.254'
			spCat_Languages_CRUD_Records @pvOptionCRUD = 'R', @pvIdLanguageUser = 'SPA', @pvIdLanguage = 'LMX' 
			spCat_Languages_CRUD_Records @pvOptionCRUD = 'U', @pvIdLanguageUser = 'SPA', @pvIdLanguage = 'LMX' , @pvShortDesc = 'Español Latam', @pvLongDesc = 'Español Latinoamerica Log Desc', @pbStatus = 0, @pvUser = 'AZEPEDA', @pvIP ='192.168.1.254'
