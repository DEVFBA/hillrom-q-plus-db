...
Example:
	...
	EXEC spQuotation_ApprovalRoutes_Get_Pending_Approval_Quotation @pvUser = 'LUMU�OZ', @piFolio = 293
	EXEC spQuotation_ApprovalRoutes_Get_Pending_Approval_Quotation @pvUser = 'LUMU�OZ', @pvUserSaleExecitive = 'ADVEGA'
	EXEC spQuotation_ApprovalRoutes_Get_Pending_Approval_Quotation @pvUser = 'LUMU�OZ', @piFolio = 2, @pvUserSaleExecitive = 'ADVEGA'
