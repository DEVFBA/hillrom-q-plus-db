...
Example:
			...
			EXEC spGSS_Commercial_Release_CRUD_Records @pvOptionCRUD = 'C', @pvIdLanguageUser = 'ANG', @pvIdItem = 'X3', @pudtGSSCommercialRelease = @udtGSSCommercialRelease , @pvUser = 'AZEPEDA', @pvIP ='192.168.1.254'			
